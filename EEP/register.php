...
<body>
      <div class="container">
        ...
        ?>
            ...
            <header>Regisztráció <a href="index.php"><button style="float: right" class="btn" type="button">Vissza</button></a></header>
            <form action="" method="post">
                <div class="field input">
                    <label for="username">Teljes Neve</label>
                    <input type="text" name="username" id="username" autocomplete="off" placeholder="Példa Béla" required>
                </div>
