...
<?php
    ...
    $sql_count = "SELECT COUNT(*) AS numJobs FROM munka WHERE Szakma = 1";
    ...
    echo "<h1>{$numJobs} festő munka elérhető</h1>";
    ...
    if ($numJobs > 0) {
        ...
        while ($row = mysqli_fetch_assoc($result)) {
            ...
            echo "<img class='hird-img' src='img/icons8-brush-100.png' alt='Festek'>";
