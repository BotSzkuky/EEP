...
<div class="jobs-list-container">
    ...
    <?php
        ...
        $sql_count = "SELECT COUNT(*) AS numJobs FROM munka WHERE Szakma = 4";
        ...
        echo "<h1>{$numJobs} villanyszerelő munka elérhető</h1>";
        ...
        if ($numJobs > 0) {
            ...
            while ($row = mysqli_fetch_assoc($result)) {
                ...
                echo "<img class='hird-img' src='img/icons8-lightning-90.png' alt='Villany'>";
