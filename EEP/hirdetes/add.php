    ...
    <div class="jobs-list-container">
        ...
        <div class="job-add">
            <div class="job-add-title">
                ...
                <input style="margin-top:10px" id="paint" type="radio" name="profession" value="1">
                ...
                <label for="gas">Gazszerelés</label><br>
        ...
        <div class="job-add">
            <div class="job-add-title">
                ...
                <input style="margin-top:10px" type="text" name="taskName" id="taskName" placeholder="Szoba festés">
            </div>
        </div>
        <div class="job-add">
            <div class="job-add-title">
                <label>Kérem adja meg a munkahely helyszínét!</label> <br>
                <input style="margin-top:10px" type="text" name="location" id="location" placeholder="Budapest">
            </div>
        </div>
        <div class="job-add">
            <div class="job-add-title">
                ...
                <input style="margin-top:10px" type="email" name="email" id="email" placeholder="pelda.bela@pelda.hu"><br>
                <p></p>
                <label for="tel">Kérem adja meg a telefonszámát ahol lehet keresni!</label><br>
                <input style="margin-top:10px" type="tel" name="tel" id="tel" placeholder="(+36)123456789">
            </div>
        </div>
        <div class="job-add">
            <div class="job-add-title">
                ...
                <textarea name="details" id="details" cols="45" rows="10" placeholder="Egy kis szoba átfestése."></textarea>
