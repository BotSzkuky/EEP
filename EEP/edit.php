...
<body>
    <div class="nav">
        <div class="logo">
        <p><a href="index.php"><img src="kepek/logo_hd_small.png" alt="logo" width="40px" style="margin-top: 5px; margin-right:5px"></a> Elite Employment Pursuit </p>
        </div>

        <div class="right-links">
            <a href="#"><button class="btn">Adatok Frissítése</button></a>
            <a href="php/logout.php"> <button class="btn">Kijelentkezés</button> </a>
        </div>
    </div>
    <div class="container">
